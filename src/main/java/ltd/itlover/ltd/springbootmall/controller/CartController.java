...
public class CartController {
    ...
    public Result add(@Valid @RequestBody CartAddForm cartAddForm,@ApiIgnore HttpSession httpSession) {
    ...
    public Result list(@ApiIgnore HttpSession httpSession) {
        Integer userId = ((User) httpSession.getAttribute(MallConstance.CURRENT_USER)).getId();
    ...
    public Result update(@PathVariable("productId")Integer productId, @ApiIgnore HttpSession httpSession, @RequestBody CartUpdateForm cartUpdateForm) {
        Integer userId = ((User) httpSession.getAttribute(MallConstance.CURRENT_USER)).getId();
    ...
    public Result selectAll(@ApiIgnore HttpSession httpSession) {
        Integer userId = ((User) httpSession.getAttribute(MallConstance.CURRENT_USER)).getId();
    ...
    public Result unSelectAll(@ApiIgnore HttpSession httpSession) {
        Integer userId = ((User) httpSession.getAttribute(MallConstance.CURRENT_USER)).getId();
    ...
    public Result sum (@ApiIgnore HttpSession httpSession) {
        Integer userId = ((User) httpSession.getAttribute(MallConstance.CURRENT_USER)).getId();
